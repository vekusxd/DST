...
namespace DST.Bot.Migrations
{
    ...
    [Migration("20241228041656_AddGenerateSiteRelatedEntites")]
    partial class AddGenerateSiteRelatedEntites
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DST.Bot.Entities.BookDesignData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("PublicationDetails")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DST.Bot.Entities.SiteArticleData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("SiteArticleData");
                });

            modelBuilder.Entity("DST.Bot.Entities.SiteData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DST.Bot.Entities.BookDesignData", b =>
                {
                    b.HasOne("DST.Bot.Entities.User", "User")
                        .WithOne("BookDesignData")
                        .HasForeignKey("DST.Bot.Entities.BookDesignData", "UserId")
            ...
            modelBuilder.Entity("DST.Bot.Entities.SiteArticleData", b =>
                {
                    b.HasOne("DST.Bot.Entities.User", "User")
                        .WithOne("SiteArticleData")
                        .HasForeignKey("DST.Bot.Entities.SiteArticleData", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DST.Bot.Entities.SiteData", b =>
                {
                    b.HasOne("DST.Bot.Entities.User", "User")
                        .WithOne("SiteData")
                        .HasForeignKey("DST.Bot.Entities.SiteData", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
